import { B as d, s as v } from './index-3e2ded46.js';
const c = [];
function b(e, t = d) {
	let n;
	const s = new Set();
...
function R() {
	...
	async function s() {
		clearTimeout(n);
		const o = await fetch(`${m}/_app/version.json`, { headers: { pragma: 'no-cache', 'cache-control': 'no-cache' } });
		if (o.ok) {
...
export { S as I, _ as P, A as S, O as a, V as b, U as c, I as d, N as e, L as f, T as g, y as h, k as i, $ as s };
