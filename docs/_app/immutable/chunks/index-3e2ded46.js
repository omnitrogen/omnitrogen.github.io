...
function $t(t, n) {
	...
	for (const r of n.childNodes)
		if (r.nodeType === 8) {
			...
			s === `HEAD_${t}_END` ? ((i -= 1), e.push(r)) : s === `HEAD_${t}_START` && ((i += 1), e.push(r));
		} else i > 0 && e.push(r);
	return e;
}
function wt(t, n) {
...
function rt(t, n) {
	const e = t.$$;
	e.fragment !== null &&
		(p(e.on_destroy), e.fragment && e.fragment.d(n), (e.on_destroy = e.fragment = null), (e.ctx = []));
}
function ct(t, n) {
	t.$$.dirty[0] === -1 && (d.push(t), z(), t.$$.dirty.fill(0)), (t.$$.dirty[(n / 31) | 0] |= 1 << n % 31);
}
	...
	if (
		((u.ctx = e
			? e(t, n.props || {}, (f, y, ...j) => {
					...
					return (
						u.ctx && r(u.ctx[f], (u.ctx[f] = C)) && (!u.skip_bound && u.bound[f] && u.bound[f](C), a && ct(t, f)), y
					);
			  })
			: []),
		u.update(),
